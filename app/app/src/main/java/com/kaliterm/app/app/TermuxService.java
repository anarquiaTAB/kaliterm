...
import com.kaliterm.app.app.event.SystemEventReceiver;
import com.kaliterm.app.app.terminal.TermuxTerminalSessionActivityClient;
import com.kaliterm.app.app.terminal.TermuxTerminalSessionServiceClient;
import com.kaliterm.app.shared.termux.plugins.TermuxPluginUtils;
import com.kaliterm.app.shared.data.IntentUtils;
import com.kaliterm.app.shared.net.uri.UriUtils;
import com.kaliterm.app.shared.errors.Errno;
import com.kaliterm.app.shared.shell.ShellUtils;
import com.kaliterm.app.shared.shell.command.runner.app.AppShell;
import com.kaliterm.app.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.kaliterm.app.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.kaliterm.app.shared.termux.shell.TermuxShellUtils;
...
import com.kaliterm.app.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.kaliterm.app.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.kaliterm.app.shared.termux.shell.TermuxShellManager;
import com.kaliterm.app.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.kaliterm.app.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.kaliterm.app.shared.logger.Logger;
import com.kaliterm.app.shared.notification.NotificationUtils;
...
import com.kaliterm.app.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.kaliterm.app.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.kaliterm.app.shared.R.string.error_execution_cancelled))) {
