package com.kaliterm.app.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.kaliterm.app.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.kaliterm.app/10xxx}
             */
