...
import com.kaliterm.app.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (mClient.isTerminalViewSelected()) {
            if (mClient.shouldEnforceCharBasedInput()) {
                ...
                // https://github.com.kaliterm.app/termux-app/issues/686
                ...
                // https://github.com.kaliterm.app/termux-packages/issues/25
                // https://github.com.kaliterm.app/termux-app/issues/87.
                // https://github.com.kaliterm.app/termux-app/issues/126.
                // https://github.com.kaliterm.app/termux-app/issues/137 (japanese chars and TYPE_NULL).
        ...
        // keyboard on Android TV (see https://github.com.kaliterm.app/termux-app/issues/221).
     ...
     * https://github.com.kaliterm.app/termux-app/pull/2237
     * https://github.com/agnostic-apollo/termux-app/blob/terminal-code-point-custom-mapping/terminal-view/src/main/java/com.kaliterm.app/view/TerminalView.java
     *
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // https://github.com.kaliterm.app/termux-app/issues/731
     ...
     * {@link com.kaliterm.app.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.kaliterm.app.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
